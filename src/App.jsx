  ...
  const planetData = [
    {
      ...
      images: {
        planet: imgMercury,
        internal: imgMercuryInternal,
        geology: imgMercuryGeology,
      },
    },
    {
      name: "Venus",
      ...
      images: {
        planet: imgVenus,
        internal: imgVenusInternal,
        geology: imgVenusGeology,
      },
    },
    {
      name: "Earth",
      ...
      images: {
        planet: imgEarth,
        internal: imgEarthInternal,
        geology: imgEarthGeology,
      },
    },
    {
      name: "Mars",
      ...
      images: {
        planet: imgMars,
        internal: imgMarsInternal,
        geology: imgMarsGeology,
      },
    },
    {
      name: "Jupiter",
      ...
      images: {
        planet: imgJupiter,
        internal: imgJupiterInternal,
        geology: imgJupiterGeology,
      },
    },
    {
      name: "Saturn",
      ...
      images: {
        planet: imgSaturn,
        internal: imgSaturnInternal,
        geology: imgSatrunGeology,
      },
    },
    {
      name: "Uranus",
      ...
      images: {
        planet: imgUranus,
        internal: imgUranusInternal,
        geology: imgUranusGeology,
      },
    },
    {
      name: "Neptune",
      ...
      images: {
        planet: imgNeptune,
        internal: imgNeptuneInternal,
        geology: imgNeptuneGeology,
      },
    },
  ];
  const [currPlanet, setCurrPlanet] = useState(planetData[0]);
  ...
  return (
    <>
      ...
      <section className="section">
        <PlanetContainer currPlanet={currPlanet} />
        <PlanetFooter currPlanet={currPlanet} />
      </section>
    </>
  );
}
